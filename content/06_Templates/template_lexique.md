...
- **Fonctionnement technique**  
  ...
  - Schéma logique ou déroulement (workflow, séquence, etc.)
- **Rôles & fonctions** dans la cybersécurité
- **Avantages et limites**
- **Typologies ou variantes** (ex : VPN site-à-site vs client-à-site, DMZ physique vs logique)
...
- Liens vers guides de référence (ex : ANSSI, NIST, etc.)
